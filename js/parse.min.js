parse.min.js! function(a) {
    a.Parse = a.Parse || {}, a.Parse.VERSION = "js1.2.18"
}(this),
function() {
    var a = this,
        b = a._,
...
function(a) {
    ...
    b.serverURL = "https://api.parse.com", "undefined" != typeof process && process.versions && process.versions.node && (b._isNode = !0), b.initialize = function(a, c, d) {
        ...
        if ("batch" !== c && "classes" !== c && "events" !== c && "files" !== c && "functions" !== c && "login" !== c && "push" !== c && "requestPasswordReset" !== c && "rest_verify_analytics" !== c && "users" !== c && "jobs" !== c) throw "Bad route: '" + c + "'.";
        var k = b.serverURL;
    ...
    b.Promise = function() {
        ...
        then: function(a, c) {
            var d = new b.Promise,
                e = function() {
                    var c = arguments;
                    a && (c = [a.apply(this, c)]), 1 === c.length && b.Promise.is(c[0]) ? c[0].then(function() {
                    ...
                    var e = [];
                    c ? (e = [c(a)], 1 === e.length && b.Promise.is(e[0]) ? e[0].then(function() {
                        d.resolve.apply(d, arguments)
                    }, function(a) {
                        d.reject(a)
                    }) : d.reject(e[0])) : d.reject(a)
                };
            return this._resolved ? e.apply(this, this._result) : this._rejected ? f(this._error) : (this._resolvedCallbacks.push(e), this._rejectedCallbacks.push(f)), d
        },
        always: function(a) {
    ...
    b.Object = function(a, d) {
        ...
        _resetCacheForKey: function(a) {
            ...
            if (!(!c.isObject(d) || d instanceof b.Object || d instanceof b.File)) {
                ...
                if (this._hashedJSON[a] !== e) return this._hashedJSON[a] = e, !0
            }
            return !1
        },
            ...
            return b.Promise._continueWhile(function() {
                ...
                return f.find().then(function(c) {
                    ...
                    return b._.each(c, function(b) {
                        ...
                        c.length >= f._limit ? f.greaterThan("objectId", c[c.length - 1].id) : g = !0
                    })
                })
            })._thenRunCallbacks(d)
        }
